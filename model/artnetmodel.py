...
class ArtNetModel():
    ...
    def predict(self, data):
        ...
        # Note also swapping height, width order
        (height, width, _) = img.shape
        return bboxes, probs, width, height, ratio

    def predict_onto_image(self, data):
        """Predict on data received, and return image with bboxes on top."
        ...
        bboxes, probs, width, height, ratio = self.predict(data)
